...
function custom_plugin_new_lead_page() {
    ...
    <div class="wrap custom-plugin-new-lead">
        ...
        <form method="post" action="<?php echo esc_url(admin_url('admin.php?page=custom-plugin-all-leads')); ?>">
...
// Callback function to display all leads and search functionality
function custom_plugin_all_leads_page() {
    ...
    ?>
        <div class="wrap custom-plugin-all-leads">
            ...
            <!-- Search Form -->
            <form method="get">
                <input type="hidden" name="page" value="custom-plugin-all-leads">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="manage-column column-name">
                                        <a href="<?php echo esc_url(add_query_arg(['orderby' => 'name', 'order' => $order === 'DESC' && $orderby === 'name' ? 'ASC' : 'DESC'], admin_url('admin.php?page=custom-plugin-all-leads'))); ?>">
    ...
    if (isset($_POST['bulk_delete'])) {
        ...
        'option' => 'leads_per_page'
                ...
                function custom_plugin_add_menu() {
                    ...
                    add_menu_page(
                        __('View Leads', 'custom-plugin'),
                        __('View Leads', 'custom-plugin'),
                        'manage_options',
                        'custom-plugin-all-leads',
                ...
                add_submenu_page(
                'custom-plugin-all-leads',
                __('Create Lead', 'custom-plugin'),
                __('Create Lead', 'custom-plugin'),
                'manage_options',
                'custom-plugin-new-lead',
                'custom_plugin_new_lead_page'
                );
}
